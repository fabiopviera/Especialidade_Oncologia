...
dat.est.Norte <- read_xlsx("Estabelecimentos_Norte.xlsx")
dat.est.Nordeste <- read_xlsx("Estabelecimentos_Nordeste.xlsx")
dat.est.Sudeste <- read_xlsx("Estabelecimentos_Sudeste.xlsx")
dat.est.Centro.Oeste <- read_xlsx("Estabelecimentos_centro_Oeste.xlsx")
dat.est.Sul <- read_xlsx("Estabelecimentos_Sul.xlsx")

load("NORTE_ONCO_COMPLETO.RData")
load("NORDESTE_ONCO_COMPLETO.RData")
load("SUDESTE_ONCO_COMPLETO.RData")
load("CENTRO_OESTE_ONCO_COMPLETO.RData")
load("SUL_ONCO_COMPLETO.RData")
```
